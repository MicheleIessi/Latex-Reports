...
The general workflow diagram is in figure \ref{figure:translation}.
\newpage
\begin{figure}[ht]
	\begin{center}
...
As an example, we show this process for the MergeSort algorithm in Listing \ref{lst:mergesort_original}.
...
The code in Listings \ref{lst:mergesort_header} and \ref{lst:mergesort_c} represent the final \texttt{.h} and \texttt{.c} files.
